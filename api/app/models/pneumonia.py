...
class PneumoniaClassifier(BaseClassifier):
    """
    Pneumonia detection from chest X-rays using EfficientNet-V2-S.
    Classifies into: NORMAL, PNEUMONIA
    """

    def __init__(self):
        super().__init__()
        self.model_name = "pneumonia"
        self.image_size = 224
    ...
    def load_model(self, weights_path: str, config_path: str) -> None:
        ...
        Args:
            ...
            config_path: Path to pneumonia_config.json
        """
